          ...
          <div className="home-hero-grid">
            ...
            <div className="animate-fade-up">
              ...
              <h1 className="home-hero-title">
                Find Government Jobs You Are{" "}
                <span className="logo-accent">Eligible</span> For
              </h1>
              <p className="home-hero-subtitle">
                Stop checking multiple websites. Complete your profile once, and
                our engine filters matching jobs based on your Age, Category,
                and Qualification!
              </p>
              ...
              <div className="home-hero-actions">
                ...
                <Link
                  to="/jobs"
                  className="btn btn-outline btn-lg home-hero-btn-outline"
                >
                  Browse All Jobs
                </Link>
              </div>
            ...
            <div className="animate-fade-in home-demo-wrapper">
              <div className="card card-glass home-demo-card">
                <h3 className="home-demo-title">
                  <Sparkles size={18} className="logo-accent" /> Dynamic
                  Profiler
                </h3>
                ...
                <div className="home-demo-footer">
                  <span className="home-demo-footer-text">
                    Eligible Matches:
                  </span>
        ...
        <div className="container">
          <div className="home-stats-grid">
            <div className="stat-card home-stat-card">
              ...
              <div className="stat-label home-stat-label">
                Active Vacancies Synced
              </div>
            </div>
            <div className="stat-card home-stat-card">
              <span className="stat-icon home-stat-icon">👨‍🎓</span>
        ...
        <div className="container">
          <div className="home-features-header">
            ...
            <p className="text-muted">
              Tools to simplify your career matching.
            </p>
          </div>
          <div className="home-features-grid">
            <div className="card shadow-sm home-feature-card">
              ...
              <p className="text-muted home-feature-desc">
                Matches your age with category relaxation rules, evaluates
                educational qualifications hierarchy, and recommends only the
                jobs you are fully eligible to apply for.
              </p>
            </div>
            <div className="card shadow-sm home-feature-card">
              <div className="home-feature-icon-box">
              ...
              <p className="text-muted home-feature-desc">
                Fetches government job vacancies in real-time from automated
                scrapers, saving you from check-up errors and ensuring you get
